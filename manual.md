...
git clone https://github.com/transitive-bullshit/tsi-form-entries.git
mv tsi-form-entries react-poop-emoji
cd react-poop-emoji
rm -rf .git
```
...
sed -i 's/tsi-form-entries/react-poop-emoji/g' *.{json,md} src/*.js example/*.json example/src/*.js example/public/*.{html,json}
